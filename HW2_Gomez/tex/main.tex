...
\begin{eqnsection}{1em}{b11) can be done by expressing it as a sum:}
  ...
  x\ast h &= \sum_{k=-\infty}^{\infty}x(n)h(n-k)\ = \sum_{k=-\infty}^{\infty}h(k)x(n-k)\\
    ...
    &= \sum_{k=1}^{n} = \frac{1-r^n}{1-r}\ \ \& \quad r = \frac{1}{2}\\
    &=\left(\frac{1}{2}\right)^{n}\frac{1-\left(\frac{1}{2}\right)^n}{1-\left(\frac{1}{2}\right)}\\
    &=\frac{\left(\frac{1}{2}\right)^{n}-\left(\frac{1}{2}\right)^{n}\left(\frac{1}{2}\right)^n}{\left(\frac{1}{2}\right)}\\
    &=2\left(\left(\frac{1}{2}\right)^{n}-\left(\frac{1}{2}\right)^{2n}\right)\\
    &=\left(\left(\frac{1}{2}\right)^{n+1}-\left(\frac{1}{2}\right)^{2n+1}\right)\\
